      ...
      <section>
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Button onClick={() => router.push('/product/listing/all-products')}>Explore Shop Collection</Button>
          </div>
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
            <div className="grid p-6 rounded place-content-center sm:p-8">
              <div className="max-w-md mx-auto text-center lg:text-left flex gap-2 flex-col">
                <h2 className="text-xl font-bold sm:text-3xl">Summer Sale Collection</h2>
                <Button onClick={() => router.push('/product/listing/all-products')}>Shop All</Button>
              </div>
            </div>
                  ...
                  ? products
                      ...
                      .map(productItem => (
                        ...
                        >
                          ...
                          <div className="mt-3">
                            <h3 className="mt-4 font-medium">{productItem.name}</h3>
                            <p className="my-2 font-medium">{`${productItem.price} EGP`}</p>
                          </div>
                        </li>
                      ))
                  : null}
            ...
            <li className="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
              <div className="relative block group">
                ...
                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
                  ...
                  <Button onClick={() => router.push('/product/listing/men')}>Shop Now</Button>
                </div>
              </div>
            </li>
          </ul>
